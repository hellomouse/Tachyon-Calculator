        ...
        <tr>
            ...
            <td>
                ...
                <button style="display: inline; width: 70px" class="modal-btn"
                    onclick="document.getElementById('modal-1').value = '-1e99'; document.getElementById('modal-1').oninput();">-INF</button>
            </td>
        </tr>
        <tr>
            <td>High</td>
            <td>
                ...
                <button style="display: inline; width: 70px" class="modal-btn"
                    onclick="document.getElementById('modal-2').value = '1e99'; document.getElementById('modal-2').oninput();">+INF</button>
            </td>
        </tr>
        <tr>
            <td>μ</td>
